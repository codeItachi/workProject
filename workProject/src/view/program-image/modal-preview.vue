<template>
    <div class="led-effect"  :class="modalstyle" v-gesture:tap.stop.prevent="shutModal()">
        <div class="show">
            <div class="animation-preview" :style="previewAnimation" v-if="localimgs">
                 <img :src="localimgs"/>
            </div>
        </div>
    </div>
...
<script>
    ...
    Vue.use(vueGesture)
    import {animationWay} from './common.js';
    ...
    export default {
        ...
        computed: {
            previewAnimation(){
                var Name = textAnimationValue(this.animationway.list[this.animationway.selectValue].value);
                return {
                    animationName: Name,
