...
Vue.use(vueGesture)
import {animationWay} from '../program-image/common.js';
import {textAnimationValue} from '../program-image/common.js';
import {textColorValue} from '../program-image/common.js';
import {textFontsizeValue} from '../program-image/common.js';
import {textFontValue} from '../program-image/common.js';
...
export default {
    ...
    computed: {
       previewAnimation(){
        let textFont = textFontValue(this.font.selectValue);
        ...
        let Name = textAnimationValue(this.animationway.list[this.animationway.selectValue].value);
        return {
            fontFamily: textFont,
            fontSize: textSize,
            color: textColor,
            animationName:Name,
            animationDuration:(15-this.speed.selectValue) + 's',
